...
namespace Eolia_IHM.Menu
{
    public partial class StatusMenu : UserControl
    {
        ...
        private void buttonLiaisonRegulateur_Click(object sender, EventArgs e)
        {
            ...
            {
                EoliaReg.InitialiserLiaisonSerieRegulateur(ConfigurationMenu.PortSerieRegulateur, labelStatutRegulateur);
                if (EoliaReg.LiaisonSerieRegulateur())
                {
                    buttonDemarrerESP32.Text = "Arrêtée liaison série";
                    esp32Demarrer = true;
        ...
        private void labelStatutRegulateur_Click(object sender, EventArgs e)
        {

        }

        private void labelStatutCapteurs_Click(object sender, EventArgs e)
        {
